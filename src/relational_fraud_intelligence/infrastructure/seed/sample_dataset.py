...
MERCHANTS = [
    ...
    "Shell-Gas", "Uber", "Netflix", "Spotify", "Steam",
    "CryptoExchange-X", "GiftCardKiosk-A", "DigitalGoods-Z",
    "LocalGrocery", "PharmacyOne", "RestaurantRow", "AirlineTickets",
    "HotelChain", "UtilityPay", "InsuranceCo",
]
CATEGORIES = [
    "retail", "food", "gas", "transport", "entertainment",
    "digital_goods", "crypto", "gift_cards", "travel", "utilities",
]
...
def generate_sample_csv() -> str:
    ...
    fieldnames = [
        ...
        "merchant", "category", "device_fingerprint", "ip_country",
        "channel", "is_fraud",
    ]
...
if __name__ == "__main__":
    ...
    out_dir = pathlib.Path(__file__).resolve().parent.parent.parent.parent.parent / "docs" / "sample_data"
